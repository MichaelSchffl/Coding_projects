# -*- coding: utf-8 -*-
"""
Created on Tue Sep 10 18:55:49 2019
...
for game in csvRead:
	...
	# season-wide home- and away-goals (loop sums up every home- and away-goal of every team):
	...
	# CALCULATING FACTORS
	# probability of scored goals of home and away team:
	if GAMES_PLAYED > (WEEKS_WAIT * 10):
	...
	# RUNNING POISSON	
		...
		with open('poisson.txt') as f:
			for line in f:
				...
				# sum up all probabilities that home team will win, away team will win, and draw.
	...
	#CALCULATE VALUE
		...
		if (ev_h == highestEV) and (ev_h > 0):
			team_bet = home_team
			ev_bet = ev_h
			# test if bet was right, because we actually know how it ended:
